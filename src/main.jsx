    ...
    <Route>
      ...
      <Route element={<BranchProtected />}>
        <Route path="/branches/home" element={<BranchLayout />}>
          ...
          <Route path="/branches/home/claim/lists" element={<BranchClaimList />} />
          <Route path="/branches/home/indorsh/lists" element={<BranchIndorshment />} />
          <Route path="/branches/home/cncl/lists" element={<BranchCancelation />} />
...
<Route path="/cic" element={<LoginAll />} />
      ...
      <Route path="/cic/home" element={<LayoutCIC />}>
          ...
          <Route path="/cic/home/cancelation/view" element={<ViewCancelation />} />
      </Route>
      </Route>
    </Route>
  )
