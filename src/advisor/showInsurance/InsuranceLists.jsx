      ...
      <div className="container-fluid flex justify-center p-1 border-gray-200 border-dashed rounded-lg  bg-slate-200">
        <div className="inline-block min-w-full  w-full py-0 ">
          <div className=" flex justify-between text-blue-700 ">
            ...
            <span className=" flex justify-center text-center text-2xl font-semibold">
              Policy&apos;s List
            </span>
            <div className="flex my-auto">
              <button
                className="text-end  mx-1 flex justify-end  text-2xl font-semibold "
              ...
              >
                <button
                  type="button"
                  className="text-white justify-end bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br py-1 focus:ring-1 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded text-sm px-2  text-center"
                >
                  Go Back
                </button>
              </NavLink>
              ...
              {isLoading ? ( // Conditional rendering for loading state
                ...
                <div className="min-w-full  border text-center bg-slate-200 text-sm font-light table">
                  {allDetailsData.length === 0 ? ( // Conditional rendering when there are no policies
                    <p className="mt-20 text-2xl font-bold flex  justify-center text-center">
                      No Advisor Found.
                    </p>
                  ) : (
                    <>
