...
function AddAttendance() {
  ...
  return (
    <section className="container-fluid relative flex flex-wrap p-0 sm:ml-48 bg-orange-50">
      <div className="container-fluid flex justify-center p-1 w-full sm:w-full md:w-full lg:w-full xl:w-full border-dashed rounded-lg  bg-orange-50">
