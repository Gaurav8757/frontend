...
function AddPolicyDetail({ insurance, onUpdates, onClose }) {
  ...
  useEffect(() => {
    if (allDetails.branch) {
      const filteredAdvisors = advLists.filter(
        (adv) => adv.branch[0] === allDetails.branch
      );
    ...
    <>
      ...
      >
        <div className="relative p-1 w-full max-w-7xl max-h-7xl mx-auto my-20">
          {/* <!-- Modal content --> */}
          <div className="relative bg-gradient-to-r from-orange-700 to-orange-700 rounded shadow ">
            {/* <!-- Modal header --> */}
            <div className="flex items-center justify-between px-3 pt-3 rounded dark:border-gray-600">
              ...
              >
                <img
                  ...
                  width={25}
                  alt="close"
                  className="hover:bg-red-100 roundedll"
                />
              </button>
            </div>
            {/* <!-- Modal body --> */}
            <section className="p-4 md:p-3 scroll-smooth hs-scroll-inside-viewport-modal rounded max-h-auto text-justify overflow-y-auto bg-gradient-to-r from-orange-700 to-orange-700">
              <div className="container-fluid flex justify-center p-1 border-gray-200 border-dashed rounded dark:border-gray-700 bg-gradient-to-r from-white to-orange-700">
                <div className="relative w-full lg:w-full p-4 lg:p-1 rounded shadow-xl text-2xl items-center bg-slate-200">
                  <div className="flex flex-wrap justify-between font-semibold">
                    ...
                    <div className="flex flex-col p-1 text-start w-full lg:w-1/5">
                      ...
                      <select
                        className="input-style w-full p-1  text-base rounded"
                    ...
                    <div className="flex flex-col p-1 mt-4  text-start w-full lg:w-1/5">
                      ...
                      <select
                        className="input-style flex flex-wrap text-base p-1 rounded"
                        name="selectedState"
