      ...
      <nav style={{ backgroundColor: "#A31217" }}>
        <div className="mx-auto max-w-auto px-2">
          <div className="relative flex  h-20 items-center justify-between">
            <div className=" inset-y-0 left-0 flex items-center sm:justify-center jus  sm:hidden">
              {/* Mobile menu button*/}
              <button
              ...
              <div className="hidden sm:ml-2  items-center sm:block md:block py-10">
                ...
                <Link to = "/login" className="relative xl:hidden sm:hidden inline-flex items-center justify-end p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-pink-500 to-orange-400 group-hover:from-pink-500 group-hover:to-orange-400 hover:text-white dark:text-white focus:ring-0 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800">
